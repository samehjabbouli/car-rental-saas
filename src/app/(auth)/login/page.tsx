    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-white to-slate-50">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 mt-2">نظام إدارة تأجير السيارات</p>
          </div>
          ...
          <div className="mt-6 p-4 bg-slate-100 rounded-xl border border-slate-200">
            <p className="text-xs text-slate-500 text-center mb-2">للاختبار، أنشئ حساب جديد أولاً من صفحة التسجيل</p>
            <p className="text-xs text-slate-400 text-center">ثم استخدم نفس البيانات لتسجيل الدخول</p>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 items-center justify-center p-12">
        <div className="max-w-md text-center text-white">
          ...
          <h2 className="text-3xl font-bold mb-4">نظام متكامل لإدارة التأجير</h2>
          <p className="text-blue-100 text-lg leading-relaxed">
            إدارة الأسطول والحجوزات والعملاء والفواتير في منصة واحدة سهلة الاستخدام
          </p>
          <div className="mt-8 flex justify-center gap-8">
            <div className="text-center">
              <p className="text-4xl font-bold">500+</p>
              <p className="text-blue-200 text-sm">شركة تستخدم النظام</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold">99.9%</p>
              <p className="text-blue-200 text-sm">وقت التشغيل</p>
            </div>
          </div>
        </div>
      </div>
